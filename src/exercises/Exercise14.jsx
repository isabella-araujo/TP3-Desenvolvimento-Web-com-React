// Crie uma página com o exercício anterior que permita editar um registro da lista e do Firestore = ALTERAR.

import React, { useEffect, useState } from 'react'
import '../style.css'
import { useForm } from 'react-hook-form';
import { addDado, alterarDado, excluirDados, getDado, getDados } from '../infra/crud';
...
export default function Exercise14() {
  ...
  async function onSubmit(dados) {
    if(idEmEdicao) {
      await alterarDado({...dados, id: idEmEdicao});
      alert("Formulário Alterado! - " + JSON.stringify(dados));
      setIdEmEdicao('');
    } else {
